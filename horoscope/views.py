...
def zodiac(request, sign):
    if sign == 'aries':
        ...
        return HttpResponse(
            'Taurus is the second of the twelve zodiac signs and is represented by the constellation, '
        ...
        return HttpResponse('Cancer is the fourth of the twelve zodiac signs and is represented by the constellation, '
                            'Cancer, which is most often depicted as a crab. If born under this sign, you\'re '
                            'considered to be bold, compassionate, protective and intuitive. Cancers are known for '
                            'their care-giving nature, as well as a tendency to be distant and passive-aggressive.')
    elif sign == 'leo':
        return HttpResponse('Leo is the fifth of the twelve zodiac signs and is represented by the constellation, '
                            'the lion. If born under this sign, you\'re considered to be vivacious, outgoing and '
                            'fiery. Leos are known for their warm nature and high self-esteem, but they can have a '
        ...
        return HttpResponse('Scorpio is the eighth of the twelve zodiac signs and is represented by the constellation, '
                            ...
                            'focused. Scorpios are known for their bravery and trailblazing nature, but they can '
                            'appear prickly and closed off to strangers.')
    elif sign == 'sagittarius':
        return HttpResponse(
            'Sagittarius is the ninth of the twelve zodiac signs and is represented by the constellation, '
        ...
        return HttpResponse(
            'Capricorn is the tenth of the twelve zodiac signs and is represented by the constellation, '
        ...
        return HttpResponse(
            'Aquarius is the eleventh of the twelve zodiac signs and is represented by the constellation, '
        ...
        return HttpResponse('Pisces is the final of the twelve zodiac signs and is represented by the constellation, '
                            ...
                            'empathetic. Pisces are known for their compassion and artistic nature, but they can have '
